...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/home/emobilis/PycharmProjects/afternoo template one/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/home/emobilis/PycharmProjects/afternoo template one/venv/bin/deactivate.nu'
